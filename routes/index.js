...
import { createSubjectController } from "../controller/subjects/createSubjects.js";
import { deleteSubjectController } from "../controller/subjects/deleteSubjects.js";
import { getSubjectsController } from "../controller/subjects/getSubjects.js";
import { updateSubjectController } from "../controller/subjects/updateSubject.js";

// Task controllers (novos e retrocompatíveis)
import { createTaskController } from "../controller/tasks/createTasks.js";
import { deleteTaskController } from "../controller/tasks/deleteTasks.js";
import {
  getTaskByIdController,
  getTasksController,
} from "../controller/tasks/getTasks.js";
import { updateTaskController } from "../controller/tasks/updateTask.js";

// Note controllers (novos e retrocompatíveis)
import { createNoteController } from "../controller/notes/createNotes.js";
import { deleteNoteController } from "../controller/notes/deleteNotes.js";
import {
  getNoteByIdController,
  getNotesController,
} from "../controller/notes/getNotes.js";
import { updateNoteController } from "../controller/notes/updateNote.js";

// Attendance controllers
import { deleteAttendanceController } from "../controller/attendance/deleteAttendance.js";
import {
...
export const routes = (app) => {
  ...
  app.get(
    "/subjects/:subjectId/attendance/:date",
    getAttendanceByDateController
  );

  // Buscar estatísticas de presença de uma matéria
  app.get(
    "/subjects/:subjectId/attendance-stats",
    getAttendanceStatsController
  );
